...
私が実際に作業したサタリナさんでのQuest Excellent対応の記録を元に、全体の作業の流れを簡単に解説します。

それぞれの工程における細かい作業の解説は、次の章から記すことにします。
...
- 歯・舌
- 後頭部・髪の裏側
- 頬染め表情に使用する染め部分が表示されるポリゴン ※ 頬染めアニメーションはあとで直せます
...
また、スカートについてはダイナミックボーンなしでも足に追従させたいため、新たにウェイトを塗って調整します。

※ ウェイト塗りについては、一般的な服オブジェクトに対するウェイトの塗り方と同じ方法であるため、本書においては解説しません。ちなみに、ローポリ化対応後なので比較的楽です。

### <u>シェイプキー</u>の修正

ポリゴンの削減作業の結果、全てのシェイプキーが下画像のように壊れます。どうやっても防ぐ方法はないようで、頑張って元の表情に近くなるように直します。
